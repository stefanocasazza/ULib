...
bool UMySqlStatement::setBindParam(UOrmDriver* pdrv)
{
   ...
   if (num_bind_param &&
      ...
      mysql_vparam = (MYSQL_BIND*) UMemoryPool::pmalloc(num_bind_param, sizeof(MYSQL_BIND), true);
...
#  endif
   ...
   if (mysql_vresult == U_NULLPTR)
      ...
      mysql_vresult = (MYSQL_BIND*) UMemoryPool::pmalloc(num_bind_result, sizeof(MYSQL_BIND), true);
