...
extern U_EXPORT bool runPYTHON(const char* script, const char* project_root, const char* project_app, const char* virtualenv_path);
       U_EXPORT bool runPYTHON(const char* script, const char* project_root, const char* project_app, const char* virtualenv_path)
{
   U_TRACE(0, "::runPYTHON(%S,%S,%S,%S)", script, project_root, project_app, virtualenv_path)
   ...
   if (script)
      ...
      PyObject* py_result = (PyObject*) U_SYSCALL(PyObject_CallObject, "%p,%p", py_userver_on_request_func, py_func_args);
      ...
      {
      U_INTERNAL_ASSERT_POINTER(project_app)
      ...
      char* sargv[] = { (char*)U_PROGRAM_NAME, (char*)project_root, (char*)project_app, (char*)virtualenv_path };
...
extern U_EXPORT void UPYTHON_end();
       U_EXPORT void UPYTHON_end()
{
   U_TRACE_NO_PARAM(0, "UPYTHON_end()")
